...
+ (NSString *)documentsDirectoryPath {
	...
	if (nil == __docsDirectory) {
		__docsDirectory = [NSSearchPathForDirectoriesInDomains(NSDocumentDirectory, NSUserDomainMask, YES) firstObject];
	}
...
+ (NSString *)libraryDirectoryPath {
	...
	if (nil == __libraryDirectory) {
		__libraryDirectory = [NSSearchPathForDirectoriesInDomains(NSLibraryDirectory, NSUserDomainMask, YES) firstObject];
	}
...
+ (NSString *)applicationDataPath {
	...
	if (nil == __applicationDataDirectory) {
		__applicationDataDirectory = [NSSearchPathForDirectoriesInDomains(NSApplicationSupportDirectory, NSUserDomainMask, YES) firstObject];
	}
